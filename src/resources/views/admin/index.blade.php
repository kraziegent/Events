...
<item-list
    ...
    <template slot="columns" slot-scope="{ sortArray }">
        ...
        <item-list-column-header name="paid" sortable :sort-array="sortArray" :label="$t('Paid Event?')"></item-list-column-header>
        <item-list-column-header name="public" sortable :sort-array="sortArray" :label="$t('Public Event?')"></item-list-column-header>
    ...
    <template slot="table-row" slot-scope="{ model, checkedModels, loading }">
        ...
        <td>@{{ model.title }}</td>
        <td>@{{ model.paid == 1 ? "Yes" : "No" }}</td>
        <td>@{{ model.public == 1 ? "Yes" : "No" }}</td>
